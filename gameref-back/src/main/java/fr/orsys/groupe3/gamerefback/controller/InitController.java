...
public class InitController {
    ...
    public void initPlayers() {
        if (userService.getPlayers().isEmpty()) {
            ...
            PlayerDto playerThree = new PlayerDto("player", "123456789", "player3@gmail.com", LocalDate.of(1993, Month.DECEMBER, 30));
    ...
    public void initGames() {
        if (gameService.getGames().isEmpty()) {
            //FF14
            GameDto game1 = new GameDto("Final Fantasy XIV", "Explorer Éorzéa avec de nombreux compagnons", LocalDate.of(2010, Month.SEPTEMBER, 30), 4L, 6L, 4L, Arrays.asList(2L, 3L), 3L, null);
            ...
            // Hollow Knight
            GameDto game3 = new GameDto("Hollow Knight", "Sautez dans tous les sens avec un insecte agile", LocalDate.of(2017, Month.FEBRUARY, 24), 1L, 8L, 9L, Arrays.asList(2L), 2L, 4L);
            //Minecraft
            ...
            // FF7
            GameDto game6 = new GameDto("Final Fantasy VII", "Suivez l'histoire d'un mercenaire avec une épée beaucoup trop grosse pour lui", LocalDate.of(1997, Month.JANUARY, 31), 3L, 5L, 4L, Arrays.asList(2L, 3L, 5L), 2L, null);
            // Tomb Raider
            ...
            // Mario Kart 64
            GameDto game9 = new GameDto("Mario Kart 8", "Si vous ralez à cause des carapaces bleues, c'est que vous n'êtes pas si mauvais que ça !", LocalDate.of(2017, Month.APRIL, 28), 1L, 10L, 6L, Arrays.asList(1L), 2L, null);
            // Street fighter
            ...
            // Ori
            GameDto game12 = new GameDto("Ori", "Encore une petite bestiole brillante qui saute dans tous les sens", LocalDate.of(2015, Month.MARCH, 11), 2L, 1L, 5L, Arrays.asList(2L), 2L, 6L);
            // Vagrant Story
            GameDto game13 = new GameDto("Vagrant Story", "Découvrez Léamundis, la ville de tous les secrets", LocalDate.of(2000, Month.FEBRUARY, 10), 3L, 5L, 4L, Arrays.asList(3L), 2L, 6L);
            try {
